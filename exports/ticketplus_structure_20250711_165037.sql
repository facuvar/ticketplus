...
--
-- Table structure for table `clientes_gescom`
--
...
CREATE TABLE `clientes_gescom` (
  ...
  `tiene_heladera` tinyint(1) DEFAULT NULL,
  `tiene_punteras` tinyint(1) DEFAULT NULL,
  `es_foco` tinyint(1) DEFAULT NULL,
  `tope_saldo` float DEFAULT NULL,
  `credito_anticipado` tinyint(1) DEFAULT NULL,
  `adherido_fidelizacion` tinyint(1) DEFAULT NULL,
  `horario_apertura` varchar(50) DEFAULT NULL,
  `horario_cierre` varchar(50) DEFAULT NULL,
  `entrega_calle` varchar(255) DEFAULT NULL,
  `entrega_altura` varchar(10) DEFAULT NULL,
  `entrega_localidad` varchar(100) DEFAULT NULL,
  `entrega_cp` varchar(10) DEFAULT NULL,
  `geox_entrega` float DEFAULT NULL,
  `geoy_entrega` float DEFAULT NULL,
  `empresa_id` int(11) DEFAULT NULL,
  `sede_id` int(11) DEFAULT NULL,
  `deposito_id` int(11) DEFAULT NULL,
  `comentario` text DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ix_clientes_gescom_codigo` (`codigo`),
  KEY `ix_clientes_gescom_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5858 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `combos_gescom`
--
...
CREATE TABLE `combos_gescom` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codigo_madre` varchar(50) NOT NULL,
  `codigo_hijo` varchar(50) NOT NULL,
  `producto_madre_id` int(11) DEFAULT NULL,
  `producto_hijo_id` int(11) DEFAULT NULL,
  `multiplicador` int(11) DEFAULT NULL,
  `ponderacion` float DEFAULT NULL,
  `es_autoreferencia` tinyint(1) DEFAULT NULL,
  `activo` tinyint(1) DEFAULT NULL,
  `fecha_importacion` datetime DEFAULT current_timestamp(),
  `fecha_actualizacion` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `producto_hijo_id` (`producto_hijo_id`),
  KEY `ix_combos_gescom_codigo_madre` (`codigo_madre`),
  KEY `ix_combos_gescom_codigo_hijo` (`codigo_hijo`),
  KEY `ix_combos_gescom_id` (`id`),
  KEY `idx_combo_productos` (`producto_madre_id`,`producto_hijo_id`),
  CONSTRAINT `combos_gescom_ibfk_1` FOREIGN KEY (`producto_madre_id`) REFERENCES `productos` (`id`),
  CONSTRAINT `combos_gescom_ibfk_2` FOREIGN KEY (`producto_hijo_id`) REFERENCES `productos` (`id`)
...
--
-- Table structure for table `items_venta_gescom`
--

DROP TABLE IF EXISTS `items_venta_gescom`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `items_venta_gescom` (
...
--
-- Table structure for table `ventas_gescom`
--
...
CREATE TABLE `ventas_gescom` (
  ...
  `neto_real` float DEFAULT NULL,
  `iva_real` float DEFAULT NULL,
  `cod_ven` varchar(10) NOT NULL,
  `cod_zon` varchar(10) DEFAULT NULL,
  `cod_cam` varchar(10) DEFAULT NULL,
  ...
  `es_devolucion` tinyint(1) DEFAULT NULL,
  `es_fuera_ruta` tinyint(1) DEFAULT NULL,
  `cond_pago` varchar(10) DEFAULT NULL,
  `fecha_vencimiento` datetime DEFAULT NULL,
  `referencia` varchar(100) DEFAULT NULL,
  `origen_id` float DEFAULT NULL,
  `empresa_id` float DEFAULT NULL,
  `sede_id` float DEFAULT NULL,
  `usuario` varchar(50) DEFAULT NULL,
  `comentario` text DEFAULT NULL,
  `autorizado_venta` tinyint(1) DEFAULT NULL,
  `autorizado_finanzas` tinyint(1) DEFAULT NULL,
  `picking_fecha` datetime DEFAULT NULL,
  `picking_usuario` varchar(50) DEFAULT NULL,
  `fecha_creacion` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ix_ventas_gescom_comprobante` (`comprobante`),
  KEY `ix_ventas_gescom_id` (`id`)
...
-- Dump completed on 2025-07-11 16:50:38
